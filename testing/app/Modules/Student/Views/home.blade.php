...
{{--<p><h1>Get Ready..!!</h1>*******************************</p>--}}
{{--<h2 style="color: darkred">{{ Session::has('msg') ? Session::get("msg") : '' }}</h2>--}}
{{--<h3>Please Fill the Details to Continue...!!</h3>--}}
{{--<form method="post" action="/student/home" id="1">--}}
    {{--{{csrf_field()}}--}}
    ...
    {{--<p><input type="submit" onclick="show()" value="Submit"></p>--}}
{{--</form>--}}
        ...
        {{--$("#1").validate({--}}
            ...
            {{--messages:{--}}
                {{--name:{--}}
                    ...
                    {{--minlength:"Minimum 5 characters is required.."--}}
                {{--},--}}
                {{--email:{--}}
...
<form method="post" action="/student/home" id="1">
    {{csrf_field()}}
<div class="container">
    <h2 style="color: whitesmoke; text-align: center">{{ Session::has('msg') ? Session::get("msg") : '' }}</h2>
    <div id="login-box">
        <div class="logo">
            <img src="/images/img.jpg" class="img img-responsive img-circle center-block"/>
            <h1 class="logo-caption"><span class="tweak">REG</span>ISTER</h1>
        </div><!-- /.logo -->
        <div class="controls">
            <input type="text" name="name" placeholder="Enter your name" class="form-control" value="{{old('name')}}" />
            <strong class="error" style="color:red">{{$errors->first('name')}}</strong>
